                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="1000" id="templateContainer">
                            ...
                            <tr>
                                <td align="center" valign="top">
                                    <!-- BEGIN HEADER // -->
                                    <table border="0" cellpadding="0" cellspacing="0" width="1000" id="templateHeader">
                                        <tr>
            ...
            <tr>
                ...
                <tr>
                    <td class="ImageContent" valign="top" style="padding-right: 0px; padding-left: 0px; padding-top: 0; padding-bottom: 0; text-align:left;">
                        <img  align="middle"alt="" src="<?= base_url();?>assets/setting/3879ad8e7cb18729e89e5398c26b4150.png" width="220" style="max-width:1200px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="Image">
                    </td>
                    <td class="ImageContent" valign="top" align="right" style="padding-right: 0px; padding-left: 0px; padding-top: 0; padding-bottom: 0;  text-align:right;">
                        ...
                        <h3 style="  text-align:right;"><?php echo $webconfig->site_name;?></h3>
                        <p style="max-width:300px;"><?php echo $webconfig->address;?></p>
                        <p><?php echo $webconfig->organization_email;?></p>
                        <p><?php echo $webconfig->other_mobile;?></p>
                        </div>
                    </td>
                </tr>
                    </tbody></table>
                            ...
                            <tr>
                                <td align="center" valign="top">
                                    <!-- BEGIN BODY // -->
                                    <table border="0" cellpadding="0" cellspacing="0" width="1000" id="templateBody">
                                        <tr>
    ...
    <tbody class="TextBlockOuter">
        <tr>
            <td valign="top" class="TextBlockInner">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="1000" class="TextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="TextContent" style="padding-top:30px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">
                            ...
                            <span style="font-size:24px"><span style="font-family:arial,helvetica neue,helvetica,sans-serif"><strong><span style="color:#3a85e2">
                                <span style="font-size:30px; line-height:32px;">Thank you for signing up with <?php echo $webconfig->domain_name;?>! We hope you enjoy your time with us.</span></span><br>
</strong></span></span><br />

<p>Website is the easiest way to reach to your customer’s desk. Making website is a combination technology, logic and art. Website is useful for each and every field in market.</p>
<p>We can classify websites in 5 major categories. </p>
<ul>
	<li>Informative websites</li>
	<li>E-commerce website</li>
	<li>Services portal website</li>
	<li>Database storage and management website</li> 
	<li>Social networking Websites</li>

</ul>
					<p><strong><u>Informative websites:</u></strong> Website which provides complete details includes about, products, services, contacts, locations etc… about any brand/person/company is known as informative website.</p>
					<p><strong><u>E-commerce website:</u></strong> A web platform, where you can establish you shop – buy and sell products and services is known as e-commerce website. </p>
					<p><strong><u>Services Portal Website:</u></strong> a web application which allows so many users to join a single platform and share their skills/ services, these data is displayed to required audience who can select the appropriate person for suitable service.</p> 
					<p><strong><u>Database storage and management website:</u></strong> a special customize online platform, created to manage data and store it category wise. Using these kinds of websites, we can store data, fetch data, search data and access data any ware.</p> 
					<p><strong><u>Social networking website:</u></strong>a platform where user can gather and share personal as well as professional updates and keep touch with relative people.</p> 
					<p>Website designing depends on the base of 5Cs. </p>
					<p style="text-align:center;"><img src="http://websitepreview.vrasm.com/images/chapter-1.png" /></p>
