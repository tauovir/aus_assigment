...
<head>
    ...
    <meta name="author"content="https://www.fullhomeworkhelp.com/"/>
 <meta name="distribution" content="Global" />
 <link rel="canonical" href="https://www.fullhomeworkhelp.com/"/>
 <meta name="robots" content="index, follow" />
 <meta name="googlebot" content="index, follow" />
 <meta name="google-site-verification"content="JXVevcA2_Hr3XN7crXIe9MJIjorWB0p-YgSD-NVWyj8"/>
 <link rel="alternate" hreflang="x-default" href="https://www.fullhomeworkhelp.com/" />
 <script async src="https://www.googletagmanager.com/gtag/js?id=UA-154969182-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());
  gtag('config', 'UA-154969182-1');
</script>
...
<?php } else { ?>
    ...
    <title> Fullhomeworkhelp - About Us </title>
    <meta name="description" content="Fullhomeworkhelp best Assignment Writing Service Company in World. Consult ourbest highly-qualified writers." />
    <meta name="keywords" content=" About Us ">
    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Fullhomeworkhelp - About Us" />
    <meta property="og:description" content=" " />
    <meta property="og:url" content="https://www.fullhomeworkhelp.com/pages/about" />
    <meta property="og:site_name" content=" FullHomeworkHelp" />
    <meta name="twitter:card" content="app" />
    <meta name="twitter:description" content="Fullhomeworkhelp best Assignment Writing Service Company in World. Consult ourbest highly-qualified writers." />
    <meta name="twitter:title" content="Fullhomeworkhelp - About Us" />
    <meta name="twitter:site" content="@Fullhomeworkhelp - About Us" />
    <meta name="twitter:creator" content="@Fullhomeworkhelp - About Us" />
    ...
    <div class="tl-top-bar">
        <div class="container">
            <div class="column-left">
                <a href="tel:+91<?php echo $webconfig->other_mobile;?>" class="header-phone"><i class="fa fa-phone-square"></i>Call our support team: <?php echo $webconfig->other_mobile;?></a>
            </div>
                        ...
                        <div class="col-sm-7">
                            <div class="breadcrumbalign">
                               ...
                               <i class="fa fa-angle-right"></i>
                                    <li><a href="<?= base_url();?>pages/samples" title="About">Samples</a></li>
                            <i class="fa fa-angle-right"></i>
                     <li><a href="javascript:void();" title="<?= $my_smples->name;?>"><?= $my_smples->name;?></a></li> </ul>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="well">
      <div class="media">
        ...
        <h4 class="media-heading"><?= $my_smples->name;?></h4>
          <div class="col-xs-12"><?= $my_smples->visibl_text;?></div>
 ...
 <div class="well blr">
      <div class="media mdi_blrs">
        <div class="media-body mdi_bdata">
          <div class="col-xs-12 all_datab"><?= $my_smples->hide_text;?></div>
         
       </div>
    </div>
  </div>
<style type="text/css">
    .blr, .mdi_blrs, .mdi_bdata, .all_datab, .all_datab>p,.all_datab>p>span,.all_datab>span{
        color: #bf0a0a00 !important;
    text-shadow: 7px 14px 6px rgba(0, 0, 0, 0.66) !important;
    user-select: none;
}
