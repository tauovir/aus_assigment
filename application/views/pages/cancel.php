...
<div id="#login-area" class="login-area default-padding">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h3 class="text-center text-danger">Your order is cancelled</h3>
...
<?php } ?>
        ...
        <div class="col-md-12 text-left">
          <br />
              <h4>Description</h4>
              <p class="text-justify"  style="   padding:20px;  max-height: 300px;
    overflow: scroll;"><?=$order_data->assi_desrip;?></p>
        </div>
    </div>
 </div>
      </div>
...
<a href="<?= base_url();?>my-order" class="btn btn-danger btn-cancel  btn-sm">Cancel</a>
