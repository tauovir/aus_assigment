  <!-- Start Breadcrumb 
    ...
    <div class="faq-area left-sidebar course-details-area default-padding">
        <div class="container">
            <div class="row">
                    <div class="col-md-6 col-sm-12" style="background: #ffb60617;padding: 10px;">
 ...
 -->
                ...
                <div class="col-md-6 faq-content">
                    ...
                    <div class="acd-items acd-arrow">
                        ...
                        <?php $count=1; foreach($faq_data as $faqdata){ ?>    

                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a data-toggle="collapse" data-parent="#accordion" href="#ac<?= $count;?>" title="<?php echo $faqdata->title; ?>">
                                            <?php echo $faqdata->title; ?>
                                        </a>
                                    </h4>
                                </div>
                                <div id="ac<?= $count;?>" class="panel-collapse collapse <?php if($count==1){ ?>in<?php } ?>">
