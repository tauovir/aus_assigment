            ...
            <div class="row">
                <div class="about-info">
                    <div class="col-md-6 thumb">
                        <img src="<?= base_url();?>assets/setting/<?= $about_image->image;?>" alt="Thumb">
                    </div>
                ...
                <div class="our-features">
                    <div class="col-md-4 col-sm-4">
                        <div class="item mariner">
                            ...
                            <div class="info">
                                <h4 class="text-center">Client-First</h4>
                               <?= $about_data16->pagecontent;?>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4">
            ...
            <div class="row">
                <div class="event-items">
                    ...
                    <div class="item horizontal col-md-12">
                        <div class="col-md-6 thumb bg-cover" style="background-image: url(<?= base_url();?>assets/setting/<?= $about_image6->image;?>);">
                    ...
                    <div class="item horizontal col-md-12">
                        ...
                        <div class="col-md-6 thumb bg-cover push-right" style="background-image: url(<?= base_url();?>assets/setting/<?= $about_image5->image;?>);">
