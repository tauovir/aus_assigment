...
<form action="<?php echo base_url();?>pages/faq/update/<?php echo $this->uri->segment(4); ?>" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">

	<input type="hidden" name="lastimage" value="<?php echo $website_edit_image->image;?>">
<?php  } else { ?>
<form action="<?php echo base_url();?>pages/faq/add" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
...
<input type="hidden" name="image_category" class="form-control" value="na" id="image_category"> 
								...
								<div class="form-group">
									<label for="content" class="col-sm-3 control-label"><small>Content </small></label>
									<div class="col-sm-9">
...
?>
                ...
                <tr role="row" class="odd">
                    ...
                    <td>
                        <div class="btn-group">
                            <a href="<?php echo base_url();?>pages/faq/edit/<?php echo $cimage->id; ?>" class="btn btn-info btn-xs">Edit</a>
                            <a href="<?php echo base_url();?>pages/faq/delete/<?php echo $cimage->id; ?>" class="btn btn-danger btn-xs">Delete</a>
