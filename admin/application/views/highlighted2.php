...
<form action="<?php echo base_url();?>pages/highlighted2/update/<?php echo $this->uri->segment(4); ?>" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">

	<input type="hidden" name="lastimage" value="<?php echo $website_edit_image->image;?>">
<?php  } else { ?>
<form action="<?php echo base_url();?>pages/highlighted2/add" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
...
?></div>
	...
	<div class="form-group">
									...
									<div class="col-sm-9">
									   <input type="text" name="image_category" class="form-control" value="<?php if ($this->uri->segment(3)=='edit') { echo $website_edit_image->image_category; } ?>" id="image_category">
									</div>
								</div>
...
?></div>
								...
								<div class="form-group">
									<label for="content" class="col-sm-3 control-label"><small>Notification Line </small></label>
									<div class="col-sm-9">
 
 
<textarea name="content" class="ckeditor" id="editor1"><?php if ($this->uri->segment(3)=='edit') { echo $website_edit_image->content; } ?></textarea>
...
?>
                ...
                <tr role="row" class="odd">
                    ...
                    <td>
                        <div class="btn-group">
                            <a href="<?php echo base_url();?>pages/highlighted2/edit/<?php echo $cimage->id; ?>" class="btn btn-info btn-xs">Edit</a>
                            <a href="<?php echo base_url();?>pages/highlighted2/delete/<?php echo $cimage->id; ?>" class="btn btn-danger btn-xs">Delete</a>
