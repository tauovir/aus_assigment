		...
		<div class="media">
			...
			<div class="media-body">
				<ul class="breadcrumb">
					...
					<li>Add  Samples Category</li>
				</ul>
				<h4>Add  Samples Category</h4>
			</div>
		</div><!-- media -->
	</div><!-- pageheader -->
				...
				<div class="panel panel-default">					
					<div class="panel-body">
						...
						<?php if($this->uri->segment(3)=='edit'){ ?>
							<form action="<?php echo base_url();?>Pages/category_samples/edit/<?php echo $this->uri->segment(4); ?>/update" class="" role="form" id="form" method="post" accept-charset="utf-8">
						<?php } else { ?>	
							<form action="<?php echo base_url();?>Pages/category_samples/insert" class="" role="form" id="form" method="post" accept-charset="utf-8">	
						<?php } ?>
...
<?php 
        	...
        	echo $parent_dtaa->name;
											...
											<td>                                                                            
<a href="<?php echo base_url();?>Pages/category_samples/edit/<?php echo $myresult->id; ?>/update" title="Edit" class="btn-link btn_size has-tooltip text-info" data-placement="top" data-original-title="Edit"><i class="fa fa-edit"></i></a>
<a href="<?php echo base_url();?>Pages/category_samples/delete/<?php echo $myresult->id; ?>" title="inactive" class="btn-link btn_size has-tooltip text-info" data-placement="top" data-original-title="Edit"><i class="fa fa-trash"></i></a>
