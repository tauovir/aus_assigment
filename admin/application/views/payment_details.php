    ...
    <div class="media">
      ...
      <div class="media-body">
        <ul class="breadcrumb">
          ...
          <li><?php if ($this->uri->segment(2) == 'online_orders') {
                echo 'Online';
              } else {
                echo 'Offline';
              } ?> Orders</li>
        </ul>
        <h4><?php if ($this->uri->segment(2) == 'online_orders') {
              echo 'Online';
            } else {
              echo 'Offline';
            } ?> Orders</h4>
              ...
              <table id="example" class="table table-striped table-bordered " style="width:100%">
                ...
                <tbody>
                  ...
                  ?>
                      ...
                      <tr>
                        <th>Mobile </th>
                        <td> <?php echo  $memdata->countryMobileCode;
                              if ($me->num_rows() > 0) {
                                echo ' ' . $memdata->mobile;
                              } ?></td>
                        <th>Gender </th>
                      ...
                      <tr>
                        ...
                        <td> <?php if ($me->num_rows() > 0) {
                                if ($memdata->month != 0) {
                                  echo  $memdata->day; ?>-<?= $memdata->month; ?>-<?= $memdata->year;
                                                                                }
                                                                              } ?></td>
