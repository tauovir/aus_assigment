...
<form action="<?php echo base_url();?>pages/how_it_word/update/<?php echo $this->uri->segment(4); ?>" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">

	<input type="hidden" name="lastimage" value="<?php echo $website_edit_image->image;?>">
<?php  } else { ?>
<form action="<?php echo base_url();?>pages/how_it_word/add" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
...
?>
                ...
                <tr role="row" class="odd">
                    ...
                    <td>
                        <div class="btn-group">
                            <a href="<?php echo base_url();?>pages/how_it_word/edit/<?php echo $cimage->id; ?>" class="btn btn-info btn-xs">Edit</a>
                            <a href="<?php echo base_url();?>pages/how_it_word/delete/<?php echo $cimage->id; ?>" class="btn btn-danger btn-xs">Delete</a>
