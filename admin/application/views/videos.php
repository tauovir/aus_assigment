...
<input type="hidden" name="image_category" class="form-control" value="1" id="image_category">
								...
								<div class="form-group">
									<label for="image" class="col-sm-3 control-label"><small>Type</small></label>
									<div class="col-sm-9">
									   <input type="text" name="image" class="form-control" value="<?php if ($this->uri->segment(3)=='edit') { echo $website_edit_image->type; } ?>"  class="form-horizontal" id="image"/>
